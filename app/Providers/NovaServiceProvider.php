...
use App\Nova\Metrics\BookingRequests;
use App\Nova\Metrics\BookingRequestsPerDay;
use App\Nova\Metrics\BookingRequestsStatus;
use App\Nova\Metrics\Talents;
use App\Nova\Metrics\TalentsPerDay;
use App\Nova\Metrics\Transactions;
use App\Nova\Metrics\TransactionsPerDay;
use App\Nova\Metrics\UserCountry;
...
class NovaServiceProvider extends NovaApplicationServiceProvider
{
    ...
    {
        parent::boot();
        Observable::make(TalentPost::class, TalentPostObserver::class);
    }
    ...
    protected function cards()
    {
        return [
            ...
            new UserCountry(),
            new BookingRequests(),
            (new BookingRequestsStatus())->width('2/3'),
            //  new BookingRequestsPerDay(),
            new Talents(),
            //  (new TalentsPerDay())->width('2/3'),
            new Transactions(),
    ...
    public function tools()
    {
                    ...
                    'resources' => [
                        InternalLink::make([
                         ...
                         InternalLink::make([
                            ...
                            'path' => '/resources/service-categories',
                        ]),
                        InternalLink::make([
                            'label' => 'Service',
                            'badge' => null,
                        ...
                        InternalLink::make([
                            ...
                            'badge' => null,
                            'target' => '',
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-credit-card-2-back-fill" viewBox="0 0 16 16">
                        ...
                        InternalLink::make([
                            ...
                            'path' => '/resources/booking-requests',
                        ]),
                        InternalLink::make([
                            'label' => 'Review',
                            'badge' => null,
                            'target' => '',
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-text" viewBox="0 0 16 16">
                        ...
                        InternalLink::make([
                            ...
                            'badge' => null,
                            'target' => '',
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell-fill" viewBox="0 0 16 16">
        ...
        $dashboardTools[] = (new \KABBOUCHI\LogsTool\LogsTool());
